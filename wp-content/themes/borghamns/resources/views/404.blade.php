					...
					<div class="text-start" style="max-width: 400px;">
						<div class="row">
							<div class="col-12 col-lg-6 mb-2">
								<a href="{{home_url('/foretaget')}}" class="text-decoration-hover text-decoration-none">
									<span class="icon-ion-arrow-right-c"></span>
									<span>Företaget</span>
								</a>
							</div>
							<div class="col-12 col-lg-6 mb-2">
								<a href="{{home_url('/produkter')}}" class="text-decoration-hover text-decoration-none">
									<span class="icon-ion-arrow-right-c"></span>
									<span>Produkter</span>
								</a>
							</div>
							<div class="col-12 col-lg-6 mb-2">
								<a href="{{home_url('/stensorter')}}" class="text-decoration-hover text-decoration-none">
									<span class="icon-ion-arrow-right-c"></span>
									<span>Stensorter</span>
								</a>
							</div>
							<div class="col-12 col-lg-6 mb-2">
								<a href="{{home_url('/blogg')}}" class="text-decoration-hover text-decoration-none">
									<span class="icon-ion-arrow-right-c"></span>
									<span>Blogg</span>
								</a>
							</div>
