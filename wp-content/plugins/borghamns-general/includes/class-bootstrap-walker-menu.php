<?php
/**
 * Nav menu walker class for Bootstrap nav menu.
 *
 ...
 */
class Bootstrap_Walker_Menu extends Walker_Nav_Menu {
	...
	public function start_lvl( &$output, $depth = 0, $args = null ) {
		...
		if ( 0 === $depth ) {
			...
			$dropdown_depth_class = 'dropdown-menu-depth-' . $depth;

			$classes = array( $dropdown_depth_class );
		}
		/**
		...
		if ( end( $matches[2] ) ) {
			...
			if ( 0 === $depth && ! in_array( 'mobile-nav', $classes_array, true ) ) {
				$labelledby = 'aria-labelledby="' . esc_attr( end( $matches[2] ) ) . '"';
			} else {
				$labelledby = 'mainitem-id="' . esc_attr( end( $matches[2] ) ) . '"';
			}
		}
	...
	public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
		...
		if ( $this->has_children && 0 === $depth ) {
			...
			if ( in_array( 'mobile-nav', $classes_array, true ) ) {
				$atts['id'] = 'mobile-menu-item-dropdown-' . $item->ID;
			} else {
